...
mod tests {
    ...
    fn create_new_flagged_message() {
        ...
        // Act
        let result_flagged_message = FlaggedMessage::new(key, expression, response, flags, &message_history);
        ...
        assert_eq!(flags, flagged_message.flags());
        assert_eq!(message_history.last_author_id(), flagged_message.message_history().last_author_id());
        assert_eq!(message_history.last_author_username(), flagged_message.message_history().last_author_username());
        assert_eq!(message_history.count(), flagged_message.message_history().count());
        assert_eq!(message_history.previously_last_found(), flagged_message.message_history().previously_last_found());
        assert_eq!(message_history.last_found(), flagged_message.message_history().last_found());
    }
    ...
    fn create_new_message_history() {
        ...
        // Act
        let message_history = MessageHistory::new(last_author_id.clone(), &last_author_username, count, last_found.clone(), previously_last_found.clone());
        ...
        assert_eq!(previously_last_found, message_history.previously_last_found());
